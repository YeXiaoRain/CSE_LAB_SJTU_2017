...
void commit() 
{
	system("./yfs-version -c");
	printf("commit, current version %d\n", ver++);
}

void pre()
{
	system("./yfs-version -p");
	printf("undo, current version %d\n", --ver);
}

void next()
{
	system("./yfs-version -n");
	printf("redo, current version %d\n", ++ver);
}
